...
def train(model, device, config, epochs=5, batch_size=4, save_cp=True, log_step=20, img_scale=0.5):
...
def get_args(**kwargs):
    ...
    parser.add_argument('-f', '--load', dest='load', type=str, default='yolov4.conv.137.pth',
                        help='Load model from a .pth file')
    parser.add_argument('-g', '--gpu', metavar='G', type=str, default='0',
                        help='GPU', dest='gpu')
    parser.add_argument('-dir', '--data-dir', type=str, default='Cars',
    ...
    parser.add_argument('-reso',dest='width',type=int,default= 416,help="resolution to net")
    parser.add_argument('-batch',dest='batch',type=int,default= 4,help="batch size")
